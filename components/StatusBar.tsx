...
export const StatusBar: React.FC<StatusBarProps> = ({ rowCount, selectedCount, filterActive, sortActive }) => {
  return (
    <div className="flex-shrink-0 h-6 border-t border-gray-200 dark:border-[#2d2d2d] bg-gray-50 dark:bg-[#252526] flex items-center px-4 text-xs text-gray-600 dark:text-gray-400">
        ...
        {sortActive && (
          <>
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-blue-600 dark:text-blue-400">Sorted</span>
            </div>
          </>
        )}
      </div>
